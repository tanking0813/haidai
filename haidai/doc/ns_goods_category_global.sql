...
Date: 2019-09-14 18:32:30
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for ns_goods_category_global
-- ----------------------------
DROP TABLE IF EXISTS `ns_goods_category_global`;
CREATE TABLE `ns_goods_category_global` (
...
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8mb4 AVG_ROW_LENGTH=244 COMMENT='商品分类表';
